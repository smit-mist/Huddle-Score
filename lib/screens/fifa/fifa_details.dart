...
class _FifaDetailsState extends State<FifaDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    WeirdDateFormat gameDate = WeirdDateFormat(date: widget.fifa.main.gameDate),
        deadLine = WeirdDateFormat(
          date: widget.fifa.main.deadLine,
        );

    DateTime today = DateTime.now();
    DateTime given = DateTime.parse(widget.fifa.main.deadLine);
    bool canRegister = true;
    if (today.isAfter(given)) {
      canRegister = false;
    }
    return widget.fifa == null
        ? Container()
        : SafeArea(
            child: Scaffold(
