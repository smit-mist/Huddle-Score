...
class _UserPrivacyPolicyState extends State<UserPrivacyPolicy> {
  final String _url = 'mailto:support@huddleandscore.com';
...
You hereby consent that the collection, disclosure, storage, processing and transfer of any Personal Information or any other information as disclosed under this Policy shall not cause any loss or wrongful gain to you if the same is used for the purposes stated in this Policy.''',
              ...
              Text(
                '''The security of your Personal Information is important to us. We have adopted reasonable security practices and procedure You agree that such measures are secure and adequate.
...
While we will endeavor to take all reasonable and appropriate steps to keep secure any information which we hold about you and prevent unauthorized access, you acknowledge that the no electronic medium / security measure is 100% secure and that we cannot provide any absolute assurance regarding the security of your Personal Information. We will not be liable in any way in relation to any breach of security or unintended loss or disclosure of information caused by us in relation to your Personal Information.''',
              ...
              RichText(
                text: TextSpan(
                  text:
                      '''If you need to access your Personal Information, update or correct your Personal Information for any reason, you may send such requests, updates and corrections to us at ''',
                  style: smallText,
                  children: [
                    TextSpan(
                    ...
                    TextSpan(
                      text:
                          ''' and we may take all reasonable efforts to provide you with access to your Personal Information and incorporate the changes within a reasonable period of time. In the event you wish to know the names and addresses of the third parties your personal data has been disclosed to, you may request the Company for such information by writing to ''',
                      style: smallText,
                    ),
                    TextSpan(
                      text: 'support@huddleandscore.com',
