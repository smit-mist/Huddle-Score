            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Summary',style: themeFont(w: FontWeight.bold),),
                    SizedBox(height: 1,),
              ...
              Container(
                ...
                child: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Text('Amount Payable',style: themeFont(s: 16,w: FontWeight.bold),),
                    SizedBox(height: 1,),
                    Row(
                      children: [
                        Text('Charges',style: themeFont(),),
                        Spacer(),
                        Text('₹ 750',style: themeFont(w: FontWeight.w600),)
                      ],
                    ),
                    Row(
                      children: [
                        Text('Taxes',style: themeFont(),),
                        Spacer(),
                        Text('0',style: themeFont(w: FontWeight.w600),)
                      ],
                    ),
                    Divider(color: Colors.black.withOpacity(0.5),),
                    Row(
                      children: [
                        Text('Total Amount',style: themeFont(),),
                        Spacer(),
                        Text('₹ 750',style: themeFont(w: FontWeight.w600),)
                      ],
                    ),
